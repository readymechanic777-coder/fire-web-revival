        ...
        >
          <div className="bg-card border border-primary/20 rounded-2xl p-8 shadow-[0_0_30px_hsl(var(--primary)/0.1)]">
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-display font-bold text-gradient-fire">Join AVISHKAAR</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-muted border-primary/20 focus:border-primary"
                  />
                </div>
              </div>
              ...
              <Button type="submit" className="w-full" variant="fire">
                Register
              </Button>
            </form>
