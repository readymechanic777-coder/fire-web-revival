        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <motion.div variants={fadeIn("left", "spring", 0.3, 0.6)} initial="hidden" whileInView="show" viewport={{ once: true }} className="glass-panel rounded-xl overflow-hidden">
            ...
            <div className="p-6 space-y-6 font-mono text-sm leading-relaxed">
              <p><span className="text-primary">💧</span> <span className="text-primary font-bold">Avishkaar</span> is a National Level 48-hour hackathon organized by <span className="text-secondary font-bold">Aditya Engineering College</span>, designed to bring together the brightest minds in technology and innovation.</p>
              <p><span className="text-accent">💧</span> Season 4 introduces <span className="text-primary">"The Infinite Loop of Innovation"</span> – a theme that celebrates continuous learning, iterative development, and breakthrough solutions.</p>
