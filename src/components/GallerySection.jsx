  ...
  return (
    <section ref={ref} className="relative py-24 overflow-hidden" id="gallery">
      ...
      <motion.div
        ...
        style={{
          background: 'radial-gradient(circle, hsl(25, 100%, 50% / 0.1), transparent 70%)',
        }}
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
            ...
            >
              ...
              <motion.div 
                className={`absolute inset-0 ${
                  index % 4 === 0 ? "bg-gradient-to-br from-orange-500/30 via-red-500/20 to-yellow-500/30" :
                  index % 4 === 1 ? "bg-gradient-to-br from-yellow-500/30 via-orange-500/20 to-red-500/30" :
                  index % 4 === 2 ? "bg-gradient-to-br from-red-500/30 via-yellow-500/20 to-orange-500/30" :
                  "bg-gradient-to-br from-amber-500/30 via-orange-500/20 to-red-600/30"
                }`}
                animate={{
                  opacity: [0.6, 0.8, 0.6],
                }}
              ...
              {/* Hover Overlay */}
              <motion.div 
                className="absolute inset-0 bg-background/80 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center"
                whileHover={{
                  background: 'linear-gradient(135deg, hsl(25, 100%, 50% / 0.1), hsl(45, 100%, 55% / 0.1))',
                }}
              >
                <div className="text-center p-4">
                  <motion.h3 
                    className="font-display font-bold text-foreground mb-2 text-lg"
                    initial={{ y: 10 }}
                    whileInView={{ y: 0 }}
                  >
                    {image.title}
              ...
              <motion.div 
                ...
                style={{ borderColor: 'hsl(25, 100%, 50% / 0.6)' }}
                animate={{
                  borderColor: ['hsl(25, 100%, 50% / 0.4)', 'hsl(45, 100%, 55% / 0.8)', 'hsl(25, 100%, 50% / 0.4)'],
                }}
                transition={{ duration: 2, repeat: Infinity }}
              />
              <motion.div 
                ...
                style={{ borderColor: 'hsl(25, 100%, 50% / 0.6)' }}
                animate={{
                  borderColor: ['hsl(45, 100%, 55% / 0.4)', 'hsl(25, 100%, 50% / 0.8)', 'hsl(45, 100%, 55% / 0.4)'],
                }}
              ...
              <motion.div
                ...
                style={{
                  boxShadow: '0 0 20px hsl(25, 100%, 50% / 0.4), inset 0 0 20px hsl(25, 100%, 50% / 0.1)',
                }}
              />
            </motion.div>
          ))}
